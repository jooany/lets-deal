...
class MessageServiceTest {
    ...
    void getMessageList(){
        ...
        Assertions.assertDoesNotThrow( () -> messageService.getMessageList(messageGroupId, 1L, "title", "imageUrl", false, opponentId, "opponentName", userId));
    }
    ...
    void getMessageList_invalidPermission(){
        ...
        Assertions.assertThrows(LetsDealAppException.class, () -> messageService.getMessageList(messageGroupId, 1L, "title", "imageUrl", false, opponentId, "opponentName", userId));
    }
}