...
public class SaleRes {
    ...
    @QueryProjection
    public SaleRes(Long id, String imageUrl, String title, Integer sellerPrice, SaleStatus saleStatus, Integer maxBuyerPrice, Boolean isSeller, Timestamp registeredAt, Timestamp updateAt) {
        this.id = id;
